<?php
	...
	$sql_car = "SELECT * FROM car_models;";

	$results_car = $mysqli->query($sql_car);
...
<html lang="en">
    ...
    <body>
        ...
        <div id="main">
            ...
            <p id ="description"> WHERE DO YOU WANT TO LOOK FOR CARS? </p>
        </div>
        <!-- End of Header  -->
        ...
        <form action="car_search_results.php" method="GET">

            
            <div class="form-group row" id="location">
				<div class="col-sm-9">
					<select name="city_id" id="location_text" class="form-control">
				...
				<!-- <div class="col-sm-8">
					<input id="location_text" type="text" class="form-control" placeholder="Enter City" name="city_id">
				</div> -->
			</div> <!-- .form-group -->
                ...
                <div class="row">
                    <div class="col">
                        <label class="form-check-label my-1">
                            <input type="date" class="form-cofdatentrol mt-2" name="from">
                        </label>
                    </div> <!-- .col -->
                   <!--<div class="col">
                        <label class="form-check-label my-1">
                            To:
                            <input type="date" class="form-control mt-2" name="to">
                        </label>
                    </div> <!-- .col -->
                </div> <!-- .row -->
            </div> <!-- .col -->
        ...
        <div class="form-group row" id="models">
            <label class="col-sm-3 col-form-label text-sm-right"> Car Model: </label>
            <div class="col-sm-9">
					<select name="model_id" id="car_model" class="form-control">
						<option value="" selected>-- All --</option>

						<!-- TODO: Output all venues from the DB here. -->
						<?php while ($row = $results_car->fetch_assoc()) : ?>
							<option value="<?php echo $row['id']; ?>">
        ...
        <div id="help">
            ...
            <h3> The most popular student car rentals: </h3>
            ...
            <div id="imgs">
                ...
                <div class="section">
                    <img id="one" src="img/civic2.jpeg" alt="civic">
                    <p class="name"> Honda Civic </p>
                </div>

                <div class="section">
                    <img id="two" src="img/jeep.jpeg" alt="jeep">
                    <p class="name"> Jeep Wrangler </p>
                </div>

                <div class="section">
                    <img id="three" src="img/subaru.jpeg" alt="subaru">
                    <p class="name"> Subaru Crosstrek </p>
                </div>
            </div>
        </div>
